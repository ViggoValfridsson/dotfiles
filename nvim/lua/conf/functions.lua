-- NOTE: Notes indicate new section/plugin configuration
...
local servers = {
  ...
  lua_ls = {
    Lua = {
      ...
      -- If writing non neovim config probably comment out this line
...
-- Setup each server using the modern vim.lsp API
...
-- NOTE: Shortcut to print full path of current file
